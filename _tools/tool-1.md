...
excerpt: "<b>About:</b> Lightweight tool designed to work with biological sequence data, providing various functionalities for filtering FASTQ files and manipulating FASTA files<br/><b>Status:</b> In seek of ideas how to make it perfect<br/><img src='/images/SeqForgeLite/SFL_logo_light.png' width='500px'>"
collection: tools
---
